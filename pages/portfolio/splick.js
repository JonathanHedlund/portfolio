	...
	return (
		<div className={portfolioStyles.portfolioPageContainer}>
			<PortfolioHeader
				...
				header='Splick'
				role='Co-founder - CTO'
				timeframe='April 2020 - August 2022'
			...
			<div className={portfolioStyles.portfolioPageContainerContent}>
				<div className={portfolioStyles.portfolioPageContainerContentInner}>
					...
					<PortfolioText
						text='Splick is a startup company that connects brands and influencers
					...
					<PortfolioText
						text='I started working with Splick back in April 2020 and have since then
